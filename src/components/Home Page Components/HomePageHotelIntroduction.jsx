    ...
    return(
        <div className={styles.homePageIntroduction}>
            <div className={styles.hotelIntroduction}>
                ...
                <p className={styles.hotelIntro}>Stay in our grand luxury rooms and suites, or at our Grand Presidential Suite. Indulge yourself with a day at Spa and shop for finely curated Indian artefacts at Taj Khazana. Spectacular venues make the hotel the preferred choice for business meetings, social events and weddings. </p>
                <p className={styles.hotelIntro}>The wide array of fine-dining restaurants at Taj Bengal is the best in Kolkata. Enjoy robust North-West frontier, Punjabi and Bengali cuisines at the ambient Sonargaon, authentic Chinese at Chinoiserie, and Lebanese and Mediterranean at Souk. Our award-winning 24 Hour all day dining, Cal 27 serves an assortment of world cuisines; for an on-the-go craving, there is La Patisserie and Deli. The Junction Bar and Promenade Lounge are perennial favourites; and during winters, the Grill by the Pool is a special treat. </p>
                <p className={styles.hotelIntro}>Our signature Taj hospitality infuses your time at this hotel with warmth and the utmost in personal care, service and exclusivity. Be pampered by our world-renowned butlers and enjoy sumptuous in-room-dining experiences. </p>
