        ...
        <React.Fragment>
            ...
            <div className={styles.aboutPageContainer}>
                <div className={styles.hotelDescription}>
                    <p>Novotel Kolkata Hotel & Residences stands proudly as Accor Hotel's first property in Eastern India. This hotel is a gateway to the City of Joy by being Eastern India’s one of the largest five-star facility with over 340 guest rooms.</p>
                    ...
                    <p>Novotel Kolkata has the perfect balance of fitness and wellness which allow our guest to rejuvenate at our 24 hour fitness centre which includes Spa, swimming pool and a gym. Technologically savvy banquet halls and rooms are the perfect for today’s traveler and corporate guest.</p>
                    <p>Our multi cuisine specialty all day dining restaurant The Square delivers a memorable experience, by providing a wide range of quality international dishes. Novotel Kolkata hold a special Sunday Brunch for the guests to enjoy the fresh and high quality cuisine. For coffee lovers in town, we have an offering for International Brew Experience at our Blue Tokai Café outlet.</p>
                </div>
                <div>
